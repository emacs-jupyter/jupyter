...
where =<path>= is the root directory for this project and all of the necessary
decencies are available.
...
The easiest way to install this package and all of its dependencies is to use
=cask= (https://github.com/cask/cask). Then in the top level directory of this
package, run
...
and to update any dependencies in the future

#+BEGIN_SRC shell
cask update
#+END_SRC

to also build the experimental widget support
