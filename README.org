...
** TODO =jupyter-repl-persistent-mode=
:LOGBOOK:
- State "TODO"       from              [2018-11-29 Thu 13:24]
:END:
** Widget support
...
:LOGBOOK:
- State "TODO"       from              [2018-11-29 Thu 02:50]
:END:

In addition to the results of a code block, a kernel can generate printed
output from the kernel's standard output stream or request that the frontend
display information in addition to the result of a code block.
