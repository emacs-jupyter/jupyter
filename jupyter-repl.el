...
If BODY inserts its output in the current buffer,
`jupyter-repl-handle-control-codes' will be called on the region
bounded by the inserted text generated by BODY."
